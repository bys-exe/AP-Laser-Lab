    ...
    <div className="space-y-8 md:space-y-12 font-mono pb-20">
      <header className="flex flex-col md:flex-row justify-between items-start border-b border-lab-border pb-6 md:pb-8 relative overflow-hidden">
        <div className="space-y-2">
          <h2 className="text-2xl md:text-4xl font-black text-[var(--text-main)] uppercase tracking-tighter">Experiment 08: Numerical Analysis</h2>
        ...
        <div className="lg:col-span-7 bg-lab-surface p-6 md:p-10 border border-lab-border space-y-8 md:space-y-10 shadow-2xl relative overflow-hidden">
          ...
          <div className="space-y-4 md:space-y-6 pt-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <input 
                ...
                className="flex-1 bg-lab-bg border border-lab-border px-6 md:px-8 py-4 md:py-5 text-[var(--text-main)] font-mono outline-none focus:border-cyan-500/50 transition-all shadow-inner placeholder:text-[var(--text-muted)]/30"
              />
              <button 
                onClick={checkAnswer} 
          ...
          {showSolution && (
            <motion.div 
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              className="bg-lab-bg p-6 md:p-8 border border-lab-border text-[9px] md:text-[10px] text-[var(--text-muted)] font-mono whitespace-pre-line leading-loose uppercase tracking-widest shadow-inner"
            >
              {problem.solution}
            </motion.div>
          )}
           ...
           <div className="bg-lab-surface p-6 md:p-10 border border-lab-border space-y-8 md:space-y-10 shadow-2xl relative overflow-hidden">
              ...
              <div className="space-y-4 md:space-y-6">
                 {[
                   ...
                   <div key={i} className="p-4 md:p-6 bg-lab-bg border border-lab-border flex justify-between items-center shadow-inner group relative overflow-hidden">
